...
//		// "/home/avsa/datasets/...
		string dataset_path = "/home/zsofi/Downloads/AVSA/2020AVSALab2_datasets/2020AVSALab3_datasets/"; //SET THIS DIRECTORY according to your download
...
//		string image_path = "/input/in%06d.jpg"; //path to images - this format allows to read consecutive images with filename inXXXXXX.jpq (six digits) starting with 000001
	...
	//	string image_path = ""; //path to images - this format allows to read consecutive images with filename inXXXXXX.jpq (six digits) starting with 000001
		...
		//  /home/zsofi/avsa/AVSA2020results/Lab2.2AVSA2020
		string project_root_path = "/home/zsofi/avsa/AVSA2020results/"; //SET THIS DIRECTORY according to your project
		...
		for (int c=0; c<NumCat; c++ )
		{
			...
			for (;;) {
				...
				removeSmallBlobs(bloblist, bloblistFiltered, MIN_WIDTH, MIN_HEIGHT, frame);
				...
				removeSmallBlobs(sbloblist, sbloblistFiltered, MIN_WIDTH, MIN_HEIGHT, frame);
...
//		        if (_CONSOLE_DEBUG) cout << "proc. time = " << 1000*t/t_freq << " milliseconds."<< endl;
				...
				// imwrite(results_path + baseline_seq[s]+"/"  +std::to_string(it)+".jpg", paintBlobImage(frame,bloblistFiltered, true));
				//std::cout<< ( results_path + baseline_seq[s]  +std::to_string(it)+".jpg" )<< endl;
